        ...
        void u8g2_draw_hv_line(u8g2_font_t *u8g2, int16_t x, int16_t y, int16_t len, uint8_t dir, uint16_t color)
{
    ...
    {
        case 0:
            canvas_draw_fast_hline(u8g2->canvas, x, y, len, color);
            break;
        case 1:
            canvas_draw_fast_vline(u8g2->canvas, x, y, len, color);
            break;
        case 2:
            canvas_draw_fast_hline(u8g2->canvas, x - len + 1, y, len, color);
            break;
        case 3:
            canvas_draw_fast_vline(u8g2->canvas, x, y - len + 1, len, color);
            break;
    }
